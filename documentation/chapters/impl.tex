...
\begin{compactdesc}
	...
	\item[Logic (Main):]
	Az állapotátmenet-függvényt (\emph{update}) tartalmazza, ami kezeli a felület vezérlőelemeitől vagy az emulációs ablaktól érkező eseményeket, azok hatására frissíti a jelenlegi állapotot, átmegy egy teljesen új állapotba vagy parancsot küld a másik ablaknak.
\end{compactdesc}
...
\begin{description}
\item[Nestest] \hfill \\
Részletesen végigteszteli az összes utasítást (beleértve néhány illegálisat is). A utasítások címzési módját és sorrendjét is variálja. Összesen 8991 utasítást hajt végre. A teszthez tartozó naplóval ellenőrizhetjük, hogy a regiszterek értéke és az eltelt ciklusok száma egyezik-e az elvárttal. 
...
\begin{compactitem}
	...
	\item Eskimo Bob Demo: \url{https://spoony-bard-productions.itch.io/eskimo-bob}
\end{compactitem}
