...
\begin{description}
	...
	\begin{figure}[H]
		\centering
		\vspace{0.4cm}
		\includegraphics[width=1.0\textwidth,height=70px]{indexed_indirect.png}
...
PRG-ből lehet ROM és RAM is a kazettán. Ezekben a processzor által végrehajtandó utasítások, avagy a játéklogika kapott helyet. A CHR fajtáját tekintve ROM vagy RAM memória, amely a játék sprite-jait tárolja, amik $8\times8$ pixeles kis képekből állnak. Ezeket a kis képeket ezentúl alakzatoknak fogom hívni. 
